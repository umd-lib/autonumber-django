...
class CollectingArea(models.Model):
  ...
  def get_absolute_url(self):
    return reverse('collecting_area_detail', kwargs={'pk': self.pk})
...
class AutoNumber(models.Model):
  ...
  name = models.CharField(max_length=255)
  collecting_area = models.ForeignKey(CollectingArea, on_delete=models.PROTECT, related_name='auto_numbers')

  def save(self, *args, **kwargs):
    if self.collecting_area:
      self.collecting_area.save()
